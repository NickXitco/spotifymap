...
public class FixDelimiter {
    public static void main(String args[]) throws IOException {
        BufferedReader bfReaderA = new BufferedReader(new FileReader(new File("artists.txt")));
        BufferedReader bfReaderB = new BufferedReader(new FileReader(new File("artists_with_genres.txt")));
        BufferedWriter bfWriter = new BufferedWriter(new FileWriter(new File("artists_with_genres_delimiter_fixed.txt"), false));
